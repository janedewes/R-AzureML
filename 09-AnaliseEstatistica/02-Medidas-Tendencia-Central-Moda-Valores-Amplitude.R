...
# R não tem fç pronta p moda
# abaixo exemplo p cálculo da moda:
...
diff(range(dados)) # diff é o que calcula a diferença!!!



# OBS: A media é afetada por valores extremos(outliers), já a mediana e moda não!

...
# Medidas de DispersÃ£o - Coeficiente de VariaÃ§Ã£o
...
# Nike ==> Valor médio da ação = $55.62 / desvio padrão = $5.10 (sd= variabilidade)
...
# Um investidor se sentiria mais seguro em adquirir ação da Nike, pois o preço das ações 
# teria uma variação menor, podendo assim evitar perdas e permitindo ao investidor ter 
# um investimento mais seguro.

# OBS: o CV nos dá uma forma de comparar conjuntos diferentes de dados. 

...
# Coeficiente de Curtose (Kurtosis) (cima/baixo)
...
# OBS: a maioria dos modelos de Machine Learning espera receber os dados com uma distribuição normal.
# esses exercicios servem para identificar se os dados estão ou não com distribuição normal!

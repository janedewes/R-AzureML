...
# Medidas de DispersÃ£o - Desvio Padrão e Variância
...
sd(Maq2)
sd(Maq3)
# resposta desse ex, a máquina que possui menor variabilidade. Essa máquina terá um nível maior de precisão. (Máq 1)



# OBS: valores extremos afetam a média
# sd calcula o quão distante os dados estão da média,
# isso ajuda a compreender como os dados estão distribuídos.
...
# Graus de liberdade é a diferenÃ§a entre 
# a dimensão da amostra (n) e a quantidade de parâmetros a serem avaliados na população. 

# No caso da variância amostral, é usada como referência a méia da amostra e isso tornaria o 

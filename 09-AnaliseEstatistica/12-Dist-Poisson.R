...
# OBS ---> O único parâmetro da Poisson é λ (lambda), que representa a taxa de eventos por unidade.
...
?dpois
dpois(2, 0.5) # recebe λ (lambda), que representa a taxa de eventos(2 defeitos) por unidade.
dpois(0, 0.5) # zero defeitos por unidade

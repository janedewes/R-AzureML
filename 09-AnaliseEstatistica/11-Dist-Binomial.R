...
# OBS --->Como podemos ter apenas 2 resultados possíveis, este é chamado um Experimento Binomial.
...
?dbinom
a <- dbinom(0, 5, 0.04) # os tres parametros
print(a)



# Desenhando a distribuição de probabilidades (para cada um dos numeros(5) de pessoas que faleceram)
graph <- function(n,p){
...
# Criando o gráfico de uma distribuição binomial (e salvando na pasta)
x <- seq(0,50,by = 1)
y <- dbinom(x,50,0.5)
png(file = "dbinom.png")
plot(x,y)

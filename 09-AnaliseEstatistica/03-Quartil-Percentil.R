...
# Para um grande número de observações, é interessante calcular algumas outras medidas de posição. 
# Essas medidas são uma extensão do conceito de MEDIANA.

# Exemplo: estamos conduzindo um experimento com animais. 
# Eles recebem uma droga e medimos o tempo de vida (em dias) após a ingestão dessa droga. 
...
# a segunda de 57 até 58, a terceira de 59 atá 60 e a quarta de 61 até 63.
...
# Os percentis sÃ£o os valores que separam um conjunto de dados em 100 partes iguais. 
# O percentil 10 representa o décimo percentil e terá 10% dos dados antes dele, 
# a lógica se seguir para todo percentil.

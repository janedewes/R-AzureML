...
# Data - representada por Date - Armazenados com número de dias desde 1 janeiro de 1970

# Time - representado por POSIXct - Armazenados com número de segundos desde 1 janeiro de 1970


# Formato Datas
# %d: dia do mes em 2 dígitos (13)
# %m: mes em dois digitos (01)
# %y: ano em dois digitos (82) 
...
# Formatando a saída - as.Date()=transf string em date:
as.Date("2018-06-28") 
...
#  OBS: Para fazer operações com as datas, elas devem estar no mesmo formato!
...
# O vetor de nÃºmeros pode representar o nÃºmero de dias, horas ou minutos (de acordo com o que vocÃª quer converter)
# A Linguagem R considera o ponto de início a data de 01 de Janeiro de 1970 e contabiliza o total
# de horas, minutos ou segundos, aquilo que o vetor numÃ©rico representar
...
# convertendo os valores numÃ©ricos (que podem representar horas, minutos ou segundos) desde 01 de Janeiro de 1970
# POSIXt Ã© a classe principal e POSIXct e POSIXlt sÃ£o subclasses. 
# Poderíamos usar aqui apenas POSIXct, que Ã© a subclasse (mas nÃ£o podemos usar apenas a classe principal)
...
axis(side = 4)
mtext(side = 4, line = 2.5, col = "red", "DuraÃ§Ã£o do Sono")
mtext(side = 2, line = 2.5, col = "blue", "EficiÃªncia do Sono")

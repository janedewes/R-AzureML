...
# Chaves não são obrigatórios, mas recomendados
if (x < 30)
  "Este número é menor que 30"
...
# Rep (repetição de alguma coisa, um numero tal de vezes)
rep(rnorm(10), 5)
...
# Ignora alguns elementos dentro do loop (| = ou)
for (i in 1:22) {
  if(i == 13 | i == 15)
    next
  print(i)

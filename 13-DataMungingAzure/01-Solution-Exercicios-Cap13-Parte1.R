...
# Seu trabalho é prever os votos em republicanos e democratas (variável Classificação)
...
# Impute missing values (é uma das técnicas para remover valores NA)
...
# ------------------------------ Criação do Modelo -----------------------------
# Exercício 1 - Crie o modelo NaiveBayes (probabilístico)
...
# Média
mean(nb_test_predict == testHouseVotes84$Class) # % de acerto do modelo = 93%



# Função para executar o registrar todos os resultados do modelo (bonus) 
...
# Executando o modelo 20 vezes (criar 20 modelos e compara os resultados)
...
# OBS: Refazer o procedimento sem retirar os valores NA!!!

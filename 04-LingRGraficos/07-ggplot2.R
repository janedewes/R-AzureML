...
# Esse pacote oferece mais opções de modificação, legendas prontas e formatação mais sólida.
...
install.packages("plotly") # Com esse pacote é possivel publicar online, é pago.
library(reshape2)
library(plotly)
